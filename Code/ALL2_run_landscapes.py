...
df = pd.read_csv('/Users/ioannis.siavelis/Downloads/ALL2_cell_line_proj/data/ALL_cell_line_merged_igraph_predictions_sig.txt', sep='\t')    
edges = df[['Protein1', 'Protein2']]# probably not needed, but nice to have dataframe with only edges
proteomics_quant = pd.read_csv('/Users/ioannis.siavelis/Downloads/ALL2_cell_line_proj/data/ALL_cell_line_proteomics_median_centered.txt',
                               delimiter = '\t')
...
for sample in tqdm(samples):
    ...
    func = -proteomics_quant[sample] #option to take negative
    func = func.to_dict()
...
# Save
with open('/Users/ioannis.siavelis/Downloads/ALL2_cell_line_proj/data/ALL2_sign_change_condition_negated.pkl', 'wb') as f:
